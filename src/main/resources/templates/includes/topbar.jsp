...
<%@ page import="com.sistemadevoluntariado.entity.Usuario" %>
<%@ page import="com.sistemadevoluntariado.repository.RolSistemaRepository" %>
...
<%
    ...
    String _nombreRol = (String) session.getAttribute("nombreRolUsuario");
    if (_nombreRol == null) {
        _nombreRol = new RolSistemaRepository().obtenerNombreRolDeUsuario(usuario.getIdUsuario());
        if (_nombreRol == null) _nombreRol = "Usuario";
        session.setAttribute("nombreRolUsuario", _nombreRol);
    }
%>
    ...
    <div class="top-actions">
        ...
        <div class="user-profile" id="openAvatarModal">
            ...
            <div class="info">
                ...
                <span class="role"><%= _nombreRol %></span>
            </div>
