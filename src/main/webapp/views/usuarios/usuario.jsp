                        ...
                        <% HttpSession ses=request.getSession(false); Usuario usuario=(Usuario)
                            ...
                            usuarios = (List<Usuario>) request.getAttribute("usuarios");
                                if (usuarios == null) usuarios = new ArrayList<>();
                                                                                ...
                                                                                <tbody id="usuarios-tbody">
                                                                                    ...
                                                                                    <% if (!usuarios.isEmpty()) { for
                                                                                        ...
                                                                                        <tr class="usuario-row"
                                                                                            ...
                                                                                            data-correo="<%= u.getCorreo() != null ? u.getCorreo() : "" %>"
                                                                                            data-estado="<%= u.getEstado() != null ? u.getEstado().trim() : "" %>"
                                                                                            data-creado="<%= u.getCreadoEn() != null ? u.getCreadoEn() : "" %>">
                                                                                            <td><span
                                    ...
                                    <%= u.getEstado() != null && u.getEstado().trim().equalsIgnoreCase("ACTIVO") ? "activo"
                                                                                                    : "inactivo" %>">
                                                                                                    <%= u.getEstado() %>
                                                                                                </span>
                                                                                            </td>
